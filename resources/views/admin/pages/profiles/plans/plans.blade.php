...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('profiles.index') }}" class="">Perfis</a></li>
        <li class="breadcrumb-item active"><a href="{{ route('profiles.plans', $profile->id) }}" class="">Planos</a></li>
    </ol>
